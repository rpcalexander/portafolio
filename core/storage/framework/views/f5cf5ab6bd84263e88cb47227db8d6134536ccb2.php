        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="info service-category">
                    <div class="heading">
                    <a href="http://ventas.ronncody.com" 
                        class="mybtn mybtn-bg "><span>Ver Demostración </span></a> 
                        </div>
                    </div> 
                    </div>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portfolio\core\resources\views/front/service-details.blade.php ENDPATH**/ ?>